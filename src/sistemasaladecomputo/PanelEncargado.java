...
public class PanelEncargado extends javax.swing.JFrame {

    conectar conexion;
    Connection conexion2;
    PreparedStatement preparadorSentencia;
    public PanelEncargado() throws Exception {
        initComponents();
        conexion = new conectar();
        obtenerTodoLosEncargados();
    }
       public void obtenerTodoLosEncargados()
    {
        try{
            ...
            prepararSentencia= conexion2.prepareStatement("SELECT clave,nombre,apellido FROM encargado");            
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Modulo Encargado");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PanelEncargado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new PanelEncargado().setVisible(true);
                } catch (Exception ex) {
                    Logger.getLogger(PanelEncargado.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
